        ...
        <div className="b-green-600 flex flex-col lg:flex-row gap-4">
          ...
          <div className="bg-scholera-sky w-full p-3 rounded-md flex gap-4">
            ...
            <div className="b-cyan-500 2xl:w-1/3">
              <Image src="https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="" width={144} height={144} className="w-32 h-32 rounded-full object-cover" />
            </div>
